...
<body style="background-color: #ded;">
	...
	<div class="container">
		<h2>Hello, World! Я - редактор таблиц MySQL. <small>Мой автор немного не уложился во время, поэтому на данный момент со мной Вы сможете только:</small></h2><br>
		<a class="btn btn-primary" href="table_list.php">Просмотреть уже имеющиеся таблицы</a><br><br>
		<a class="btn btn-primary" href="create_step_one.php">Создать новую таблицу</a><br><br>
		<p>Но это временно ;).</p>
	</div>
</body>
</html>